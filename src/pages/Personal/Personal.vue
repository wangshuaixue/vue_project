        ...
        <div class="login-con">
          <router-link to="/login" class="login">
            ...
            <span class="tel-con">
              ...
              <span class="tel">手机号码登录</span>
            </span>
            </div>
          </router-link>
          <div class="email-login">
            <span class="email-con">
              <span class="icon"></span>
              <span class="email">邮箱账号登录</span>
            </span>
          </div>
          <div class="phone-regist">手机号快捷注册 <span class="right-i"></span></div>
        </div>
      </div>
      <div class="login-ways-wrap">
        <div class="login-way">
  ...
  .personal-wrap{
    ...
    .login-wrap{
      ...
      .login-ways-wrap{
        ...
        .login-way:nth-child(2){
          border-left: 1/@rem solid #979797;
          border-right: 1/@rem solid #979797;
        }
      }
    }
  }
